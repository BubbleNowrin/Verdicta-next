  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      const prevBtns = document.querySelectorAll(
        '[data-slider-prev="#testiSlide11"]'
      );
      const nextBtns = document.querySelectorAll(
        '[data-slider-next="#testiSlide11"]'
      );
        ...
        <div className="row justify-content-lg-between justify-content-center align-items-end">
          <div className="col-lg">
            <div className="title-area text-center text-lg-start">
              ...
              <h2 className="sec-title">Verdicta Client Testimonials</h2>
            </div>
          </div>
            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="testi-block" dir="ltr">
                  <div className="testi-icon-1-top">
                    <img
                      src="/assets/img/icon/testi-icon-1-top.svg"
                      alt="icon"
                    />
                  </div>
                  ...
                  <p className="box-text">
                    &quot;I was struggling with family law for months before I
                    found abc. They not only provided me with the solution I
                    needed, but they also educated me on how to prevent the
                    issue from happening again. Their team is incredibly
                    knowledgeable and patient, and they always go the extra mile
                    to ensure customer satisfaction. I am so grateful for their
                    help and would recommend them to anyone.&quot;
                  </p>
                </div>
              </div>
              ...
              <div className="swiper-slide">
                <div className="testi-block" dir="ltr">
                  ...
                  <div className="testi-block-top">
                    ...
                    <div className="content">
                      <h3 className="box-title">Marcus Johnson</h3>
                      <p className="box-desig">Construction Contractor</p>
                      <div className="box-review">
                        <i className="fa-sharp fa-solid fa-star" />
                        <i className="fa-sharp fa-solid fa-star" />
                        <i className="fa-sharp fa-solid fa-star" />
                  ...
                  <p className="box-text">
                    &quot;After a serious workplace accident, Verdicta fought
                    tirelessly for my workers' compensation claim. They secured
                    full benefits and medical coverage when the insurance
                    company initially denied everything. Their dedication and
                    expertise in Alabama employment law made all the difference
                    in my recovery. Verdicta truly cares about their clients and
              ...
              <div className="swiper-slide">
                <div className="testi-block" dir="ltr">
                  ...
                  <p className="box-text">
                    &quot;Navigating family law issues was overwhelming for
                    months until I came across abc. They didn’t just solve how
                    to prevent the issue from happening again my problem—they
                    empowered me with knowledge to manage such situations
                    better. Their expertise and dedication to client
                    satisfaction left okay no problem a lasting impression. I’m
                    forever grateful and highly endorse their services.&quot;
                  </p>
                </div>
              </div>
            </div>
