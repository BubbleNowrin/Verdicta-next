const Case = () => {
    return (
      ...
      <div className="overflow-hidden space gallery-sec-3" id="case-study-sec">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-9 col-lg-10">
              <div className="title-area text-center">
                <span className="sub-title justify-content-center">Case Study</span>
                <h2 className="sec-title">Attoenwy Legal Excellence in Action</h2>
              </div>
            </div>
          </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Family Law</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Divorce Cases</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Custody Disputes</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Parental Rights</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Child Support</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Paternity Cases</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Civil Unions</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="gallery-card">
                <div className="gallery-img">
                  ...
                  <div className="gallery-content">
                    ...
                    <p className="box-text">Marriage Contracts</p>
                  </div>
                </div>
              </div>
            </div>
